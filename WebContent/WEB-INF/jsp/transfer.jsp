...
<body style="background-image: url('resources/img/8.jpg');">
	...
	<h3 style="text-align: center; margin-top: 20px">Transfer Amount</h3>




	<div class="row" style="margin-left: 15%; margin-top: 10%">
		<form action="transfer" method="post" class="form-group"
			style="margin-left: 20%; margin-top: 10px; width: 1200px">

			<label class="col-sm-2 ">To Account:</label> <input type="text"
				name="toAccount" required="required" class="col-sm-4 "><br>
